...
def stats_df(merged_base_df):
    ...
    mask_player = merged_base_df['pitched'] > 0
    if mask_player.any():
        merged_base_df.loc[mask_player, 'z%'] = merged_base_df.loc[mask_player, 'z_in'] / merged_base_df.loc[mask_player, 'pitched']
        merged_base_df.loc[mask_player, 'inplay_pit'] = merged_base_df.loc[mask_player, 'inplay'] / merged_base_df.loc[mask_player, 'pitched']
    ...
    if mask_player.any():
        merged_base_df.loc[mask_player, 'o%'] = merged_base_df.loc[mask_player, 'z_out'] / merged_base_df.loc[mask_player, 'pitched']
    ...
    if mask_player.any():
        merged_base_df.loc[mask_player, 'swing%'] = merged_base_df.loc[mask_player, 'swing'] / merged_base_df.loc[mask_player, 'pitched']
    ...
    # 출력할 컬럼 선택
    stats_output_df = merged_base_df[['game_date', 'pitched', 'pa', 'ab', 'hit', 'walk', 'rel_speed(km)', 
